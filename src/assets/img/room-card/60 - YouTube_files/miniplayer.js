(function(g){var window=this;'use strict';var Z6a=function(a){g.X.call(this,{D:"div",K:"ytp-miniplayer-ui"});this.wf=!1;this.player=a;this.T(a,"minimized",this.ih);this.T(a,"onStateChange",this.IL)},O6=function(a){g.vO.call(this,a);
this.j=new Z6a(this.player);this.j.hide();g.RN(this.player,this.j.element,4);a.Ff()&&(this.load(),g.qo(a.getRootNode(),"ytp-player-minimized",!0));this.player.V().N("web_rounded_containers")&&g.qo(a.getRootNode(),"ytp-rounded-miniplayer",!0)};
g.v(Z6a,g.X);g.k=Z6a.prototype;
g.k.aJ=function(){this.tooltip=new g.vS(this.player,this);g.N(this,this.tooltip);g.RN(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Kc=new g.pP(this.player);g.N(this,this.Kc);this.Ei=new g.X({D:"div",K:"ytp-miniplayer-scrim"});g.N(this,this.Ei);this.Ei.Da(this.element);this.T(this.Ei.element,"click",this.iE);var a=new g.X({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},W:[g.rL()]});g.N(this,a);a.Da(this.Ei.element);
this.T(a.element,"click",this.Ok);a=new g.M2(this.player,this);g.N(this,a);a.Da(this.Ei.element);this.Ds=new g.X({D:"div",K:"ytp-miniplayer-controls"});g.N(this,this.Ds);this.Ds.Da(this.Ei.element);this.T(this.Ds.element,"click",this.iE);var b=new g.X({D:"div",K:"ytp-miniplayer-button-container"});g.N(this,b);b.Da(this.Ds.element);a=new g.X({D:"div",K:"ytp-miniplayer-play-button-container"});g.N(this,a);a.Da(this.Ds.element);var c=new g.X({D:"div",K:"ytp-miniplayer-button-container"});g.N(this,c);
c.Da(this.Ds.element);this.HS=new g.RQ(this.player,this,!1);g.N(this,this.HS);this.HS.Da(b.element);b=new g.PQ(this.player,this);g.N(this,b);b.Da(a.element);this.nextButton=new g.RQ(this.player,this,!0);g.N(this,this.nextButton);this.nextButton.Da(c.element);this.Gi=new g.hS(this.player,this);g.N(this,this.Gi);this.Gi.Da(this.Ei.element);this.Cc=new g.bR(this.player,this);g.N(this,this.Cc);g.RN(this.player,this.Cc.element,4);this.XD=new g.X({D:"div",K:"ytp-miniplayer-buttons"});g.N(this,this.XD);
g.RN(this.player,this.XD.element,4);a=new g.X({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},W:[g.rL()]});g.N(this,a);a.Da(this.XD.element);this.T(a.element,"click",this.Ok);a=new g.X({D:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},W:[g.yL()]});g.N(this,a);a.Da(this.XD.element);this.T(a.element,"click",this.D3);this.T(this.player,"presentingplayerstatechange",
this.Wc);this.T(this.player,"appresize",this.Bb);this.T(this.player,"fullscreentoggled",this.Bb);this.Bb()};
...
g.k.D3=function(){this.player.playVideo()};
